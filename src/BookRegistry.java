...
// * The object Book can either be added with or without series.
// * The book can be removed from the collection or an existing book may be added to a series.
// *
...
//    {
//        this.bookList.add(new Book("Book 1", "Publisher 1", "Author 1", "First Edition", "2019.01.01"));
//        this.bookList.add(new Book("Book 2", "Publisher 1", "Author 1", "Second Edition", "2019.01.02"));
//        this.bookList.add(new Book("Book 3", "Publisher 2", "Author 1", "First Edition", "2019.01.01"));
//        this.bookList.add(new Book("Book 4", "Publisher 3", "Author 2", "First Edition", "2019.01.01"));
//        this.bookList.add(new Book("Book 5", "Publisher 1", "Author 2", "First Edition", "2019.01.01"));
//
